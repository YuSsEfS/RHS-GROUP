...
@section('page_copy', 'Apercu interne du fichier CV autorise par l administration RHS.')
        ...
        <div class="panel-body">
            ...
            @else
                <div class="ui-empty-state">
                    <div class="ui-empty-title">Apercu integre non disponible</div>
                    <div class="ui-empty-copy">Ce type de fichier doit etre ouvert en fichier brut.</div>
