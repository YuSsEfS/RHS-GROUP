...
<style>
.cv-page{display:grid;gap:18px;}
.cv-filters-sticky{position:sticky;top:16px;z-index:15;}
.cv-filters-panel,.cv-table-panel{overflow:hidden;}
...
.cv-inline-form{display:flex;gap:10px;flex-wrap:wrap;align-items:center;}
.cv-inline-form .cv-input{min-width:280px;}
...
.cv-table-wrap::-webkit-scrollbar{width:8px;height:10px;}
.cv-table-wrap::-webkit-scrollbar-track{background:#f1f5f9;border-radius:999px;}
.cv-table-wrap::-webkit-scrollbar-thumb{background:#cbd5e1;border-radius:999px;}
.cv-table-wrap::-webkit-scrollbar-thumb:hover{background:#94a3b8;}
...
.cv-table tr:hover td{background:#fcfdff;}
.cv-main{font-weight:800;color:#0f172a;line-height:1.35;}
.cv-sub{margin-top:4px;color:#64748b;font-size:13px;line-height:1.45;}
...
.cv-badge.source-application{background:#eff6ff;color:#1d4ed8;border-color:#bfdbfe;}
.cv-badge.source-external{background:#f8fafc;color:#0f172a;border-color:#cbd5e1;}
.cv-badge.source-manual{background:#ecfdf5;color:#15803d;border-color:#bbf7d0;}
.cv-badge.source-legacy{background:#fff7ed;color:#c2410c;border-color:#fed7aa;}
.cv-badge.status-inactive{background:#fef2f2;color:#b91c1c;border-color:#fecaca;}
...
.cv-bulk-actions.is-visible{display:flex;}
...
.cv-icon-btn.primary{background:#ef4444;border-color:#ef4444;color:#fff;}
.cv-icon-btn.primary:hover{background:#dc2626;border-color:#dc2626;}
.cv-icon-btn.warn{background:#fff7ed;border-color:#fed7aa;color:#c2410c;}
.cv-icon-btn.danger{background:#fff;border-color:#fecaca;color:#dc2626;}
...
.cv-empty{padding:36px 24px;text-align:center;}
.cv-empty-title{font-size:18px;font-weight:800;color:#0f172a;margin-bottom:8px;}
.cv-empty-subtitle{color:#64748b;margin-bottom:18px;line-height:1.6;}

.panel-alert{padding:14px 16px;border-radius:14px;font-weight:600;}
.panel-alert.success{background:#ecfdf5;color:#166534;border:1px solid #bbf7d0;}
...
.cv-modal-title{font-size:20px;font-weight:800;color:#0f172a;}
...
.cv-modal-body{padding:22px;display:grid;gap:18px;}
.cv-modal-text{color:#475569;line-height:1.65;}
.cv-radio-list{display:grid;gap:12px;}
...
.cv-radio-card:hover{border-color:#fca5a5;background:#fffafa;}
.cv-radio-card label{display:flex;align-items:flex-start;gap:12px;cursor:pointer;}
.cv-radio-card input[type="radio"]{margin-top:4px;accent-color:#ef4444;transform:scale(1.1);}
.cv-radio-title{font-weight:800;color:#0f172a;margin-bottom:4px;}
.cv-radio-desc{color:#64748b;font-size:14px;line-height:1.55;}
...
.cv-danger-btn{background:#ef4444 !important;border-color:#ef4444 !important;color:#fff !important;}
.cv-danger-btn:hover{background:#dc2626 !important;border-color:#dc2626 !important;}

@media (max-width:1500px){
  .cv-filters-grid{grid-template-columns:repeat(4,minmax(0,1fr));}
}

@media (max-width:1100px){
  .cv-filters-grid{grid-template-columns:repeat(2,minmax(0,1fr));}
}

@media (max-width:760px){
  .cv-filters-grid{grid-template-columns:1fr;}
  .cv-inline-row{flex-direction:column;align-items:stretch;}
  .cv-inline-form{width:100%;}
  .cv-inline-form .cv-input{min-width:0;width:100%;}
  .cv-actions{min-width:unset;}
}
</style>
...
<div class="cv-page">
  ...
  <form
    ...
    method="POST"
    onsubmit="return confirm('Supprimer les CV sélectionnés ?');"
  >
    @csrf
    @method('DELETE')
  </form>
  ...
  <div class="panel cv-table-panel">
    <div class="panel-head">
      ...
      <div class="cv-bulk-actions" id="bulkActions">
              ...
              <tr>
                ...
                <th style="text-align:right;">
                  <label style="display:flex;align-items:center;justify-content:flex-end;gap:8px;">
                    <span>Actions</span>
                    <input type="checkbox" id="selectAllCvs" class="cv-select-check" title="Tout sélectionner">
                  </label>
                </th>
              </tr>
            </thead>
...
(function () {
  ...
  function updateBulkActions() {
    const checked = document.querySelectorAll('.cv-row-check:checked').length;
